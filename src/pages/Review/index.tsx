...
export default function index() {
  return (
    ...
    <div id="container" className="curation jbFixed">
        ...
        <form name="reviewFrm" id="reviewFrm" action="/pc/dispaly/review" method="get">
            <input type="hidden" name="cPage" id="cPage" value=""/>
            <input type="hidden" name="PHOTO_ONLY" id="PHOTO_ONLY" value=""/>
            <div className="review_tit">
                <p className="title">
                    <a href="javascript:photo_only('N');">전체(<em>0건</em>)</a>
                    <a href="javascript:photo_only('Y');" className="photo">포토(<em>0건</em>)</a>
                </p>
                <select className="select_default" id="SEARCH_ORDER" name="SEARCH_ORDER">
        ...
        <div className="review">
            <ul>
                <li>
                    <div className="thumbanil" style={{cursor: 'pointer'}} onClick={() =>"product(0,'000000000005030863')"}>
                        <img src="" alt=""/>
                    </div>
                        ...
                        <div className="review_txt">
                            <div className="star_wrapper">
                                ...
                                <div className="review_text">
                                    ...
                                    <br/>
                                    <br/>
                                    <img src="" width="3024" height="4032" className="photo"/>
                                    <br/>
                                    <br/>
                                    <br/>
                                </div>
        ...
        <div className="pagintion">
            ...
            <a href="javascript:;" className="on">1</a>
            <a className="num" href="javascript:goPage(2);">2</a>
            <a className="num" href="javascript:goPage(3);">3</a>
            <a className="num" href="javascript:goPage(4);">4</a>
            <a className="num" href="javascript:goPage(5);">5</a>
